...
parameter_filename = sprintf('../iomaster/%s.csv',mname); % special parameter and experimental settings filename
results_fileroot   = sprintf('../iomaster/%s_results',mname);
...
print(sprintf('../iomaster/%s_init_fit.png',mname),'-dpng');
...
save(sprintf('../iomaster/%s_pbest.mat',mname));
...
print(sprintf('../iomaster/%s_final_fit.png',mname),'-dpng');
...
grid on;
print(sprintf('../iomaster/%s_final_params.png',mname),'-dpng');
